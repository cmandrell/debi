...
# This script writes to DEB:\LiveTest\LunarEclipse07112022 folder
# Replace Observer___ With ObserverJMW etc...
...
for q in range (0,360):
    ...
    SharpCap.TargetName = "Observer___LunarEclipse11082022_1ms"
